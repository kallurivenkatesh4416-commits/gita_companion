  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          Text('Sanskrit', style: Theme.of(context).textTheme.titleMedium),
          ...
          Card(
            child: ListTile(
              ...
              title: const Text('Audio (placeholder)'),
              subtitle: const Text('Playback integration can be connected in a later milestone.'),
              onTap: () {},
            ),
          ),
